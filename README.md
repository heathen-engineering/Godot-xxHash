> **Moved to Codeberg:** this repo now lives at [codeberg.org/Heathen-Engineering/Godot-xxHash](https://codeberg.org/Heathen-Engineering/Godot-xxHash) — please use that copy going forward. This GitHub copy will remain live for now while Heathen's Pro Toolkits finish migrating to our private Git server; once that's complete, this GitHub repo will be archived.
